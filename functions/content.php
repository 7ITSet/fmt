...
////		$attr=$sql->query('SELECT `m_products_attributes_id`,`m_products_attributes_value` FROM `formetoo_main`.`m_products_attributes` WHERE `m_products_attributes_product_id` IN (SELECT `id` FROM `m_products` WHERE `id` IN ('.implode(',',$this->getChCategories($data['current'])).'));','m_products_attributes_id');
	...
	(Product.`m_products_price_general` BETWEEN '.round(($data['FILTER[]'][0]['from']/$this->ec[3]),2).' AND '.round(($data['FILTER[]'][0]['to']/$this->ec[3]),2).' AND Product.`m_products_price_currency`=3)
		...
		$q_wo_l='SELECT 
				...
				Product.`id`, `slug`,`id_isolux`,`id`,`m_products_name_full`,`m_products_unit`,`m_products_price_general`,`m_products_price_currency`,`m_products_price_discount`,`m_products_price_bonus`,`m_products_multiplicity`,`m_products_show_site`,`m_products_date`,`m_products_order`,`m_products_exist`,`m_products_dir`,`m_products_foto`,`m_products_rate`,`m_products_feedbacks`[SELECT]
		...
		if(!$e){
			...
			elseif(is_numeric($result)){
				...
				if($links=$sql->query($q)){
					...
					$q='SELECT SQL_CALC_FOUND_ROWS `id`, `id_isolux`,`m_products_name_full`,`m_products_unit`,`m_products_price_general`,`m_products_price_currency`,`m_products_price_discount`,`m_products_price_bonus`,`m_products_multiplicity`,`m_products_show_site`,`m_products_date`,`m_products_order`,`m_products_exist`,`m_products_dir`,`m_products_foto`,`m_products_rate`,`m_products_feedbacks` 
