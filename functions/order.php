...
class order{
	...
	private function cart_data_item($data){
		...
		$q='SELECT `id`,`slug`,`m_products_price_general`,`m_products_price_bonus`,`m_products_price_currency`,`m_products_multiplicity` FROM `formetoo_main`.`m_products` WHERE 
