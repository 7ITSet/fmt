...
<?
	pre($user->getAddressInfo('ивново,кузнетная 38 1001',5));
?>
<div id="popup_add_address" class="popup" style="width:32.2em;margin-left:-16.5em;top:30%;">
	...
	<form id="form_popup_add_address">
		<div class="login_authorization_form_input_container short">
			<input type="text" name="add_address_index" placeholder="индекс" maxlength="6" autocomplete="off"/>
		</div>
		<div class="login_authorization_form_input_container">
			<input type="text" name="add_address_area" placeholder="субъект РФ *" maxlength="80" autocomplete="off"/>
		</div>
		<div class="login_authorization_form_input_container short">
			<input type="text" name="add_address_district" placeholder="район" maxlength="80" autocomplete="off"/>
		</div>
		<div class="clr"></div>
		<div class="login_authorization_form_input_container">
			<input type="text" name="add_address_city" placeholder="город/населённый пункт" maxlength="80" autocomplete="off"/>
		</div>
		<div class="login_authorization_form_input_container">
			<input type="text" name="add_address_street" placeholder="улица" maxlength="80" autocomplete="off"/>
		</div>
		<div class="clr"></div>
		<div class="login_authorization_form_input_container short">
			<input type="text" name="add_address_house" placeholder="дом" maxlength="10" autocomplete="off"/>
		</div>
		<div class="login_authorization_form_input_container short">
			<input type="text" name="add_address_corp" placeholder="корпус" maxlength="10" autocomplete="off"/>
		</div>
		<div class="login_authorization_form_input_container short">
			<input type="text" name="add_address_build" placeholder="строение" maxlength="10" autocomplete="off"/>
		</div>
		<div class="login_authorization_form_input_container short">
			<input type="text" name="add_address_mast" placeholder="владение" maxlength="10" autocomplete="off"/>
		</div>
		<div class="clr"></div>
		<div class="login_authorization_form_input_container" style="width:100%">
			<textarea name="add_address_detail" placeholder="дополнительная информация (домофон, этаж, № квартиры или офиса)" maxlength="180" style="width:100%" autocomplete="off"></textarea>
		</div>
		<div class="clr"></div>
		...
		<?}?>
		<div class="clr"><p></p></div>
		<input type="hidden" name="add_address_full" value="123"/>
		<div class="login_authorization_form_input_container" style="text-align:center;width:100%;">
