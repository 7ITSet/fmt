...
(function(window, $) {
    ...
    ImgZoom.prototype = {
        ...
        _createZoomDiv: function() {
            ...
            var zoomDivLeft = offset.left / 1 + startPos.outerWidth(true)/1 + this.opts.marginLeft / 1;
        ...
        _createMask: function() {
            ...
            this.$mask || (this.$mask = $('<div class="main_products_list_items_info_foto_preview_zoom"/>'));
            this.$mask.css({
                position: 'absolute',
